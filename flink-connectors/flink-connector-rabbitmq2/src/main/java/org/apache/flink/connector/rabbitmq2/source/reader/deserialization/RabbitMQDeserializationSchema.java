...
@PublicEvolving
public interface RabbitMQDeserializationSchema<T> extends Serializable, ResultTypeQueryable<T> {
    ...
    /**
     * Deserializes the RabbitMQ record.
     *
     * @param delivery RabbitMQ record to be deserialized.
     * @return The deserialized message as an object (null if the message cannot be deserialized).
     */
    T deserialize(Delivery delivery) throws Exception;
     ...
     * barrier.
     *
     * @param delivery The message, as a wrapper of byte array.
     * @param out The collector to put the resulting messages.
     */
    default void deserialize(Delivery delivery, Collector<T> out) throws Exception {
        T deserialized = deserialize(delivery);
