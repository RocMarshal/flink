...
public class MySQLCatalogTestBase {
    ...
    public static void init() throws SQLException {
        ...
        createTable(
                TEST_DB, new PostgresTablePath(TEST_SCHEMA, TABLE3), getSimpleTable().pgSchemaSql);
        createTable(
    ...
    public static PostgresCatalogTestBase.TestTable getSimpleTable() {
        return new PostgresCatalogTestBase.TestTable(
    ...
    public static PostgresCatalogTestBase.TestTable getPrimitiveTable() {
    ...
    // reverse conversion.
    public static PostgresCatalogTestBase.TestTable getPrimitiveTable(String primaryKeyName) {
        return new PostgresCatalogTestBase.TestTable(
                TableSchema.builder()
    ...
    public static PostgresCatalogTestBase.TestTable getArrayTable() {
        return new PostgresCatalogTestBase.TestTable(
                TableSchema.builder()
    ...
    public static PostgresCatalogTestBase.TestTable getSerialTable() {
        return new PostgresCatalogTestBase.TestTable(
                TableSchema.builder()
