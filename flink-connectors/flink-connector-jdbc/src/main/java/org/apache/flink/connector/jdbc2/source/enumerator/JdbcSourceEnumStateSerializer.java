...
public class JdbcSourceEnumStateSerializer implements SimpleVersionedSerializer<JdbcSourceEnumeratorState>, Serializable {
    ...
    @Override
    public byte[] serialize(JdbcSourceEnumeratorState obj) throws IOException {
        return new byte[0];
    }

    @Override
    public JdbcSourceEnumeratorState deserialize(int version, byte[] serialized) throws IOException {
        return null;
    }
}
