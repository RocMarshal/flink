...
package org.apache.flink.connector.jdbc2.catalog.factory;

import org.apache.flink.configuration.ConfigOption;
import org.apache.flink.connector.jdbc2.catalog.JdbcCatalog;
...
public class JdbcCatalogFactory implements CatalogFactory {
    ...
    public Catalog createCatalog(Context context) {
        ...
        return new JdbcCatalog(context, helper.getOptions());
    }
}
