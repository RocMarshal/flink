...
public abstract class JdbcSqlSplitEnumeratorBase<SplitT extends JdbcSourceSplit>
        implements Closeable, Serializable {
    private final char[] currentId = "0000000000".toCharArray();

    protected @Nullable Serializable optionalSqlSplitEnumeratorState;

    public JdbcSqlSplitEnumeratorBase(Serializable optionalSqlSplitEnumeratorState) {
    ...
    public interface Provider<Split extends JdbcSourceSplit> extends Serializable {
        JdbcSqlSplitEnumeratorBase<Split> create();

        JdbcSqlSplitEnumeratorBase<Split> restore(
