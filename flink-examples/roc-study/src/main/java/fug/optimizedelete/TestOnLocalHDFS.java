    ...
    public static void main(String[] args) throws Exception {
        ...
        env.addSource(
                        new RichParallelSourceFunction<Tuple2<Integer, Integer>>() {
                            ...
                            @Override
                            public void run(SourceContext<Tuple2<Integer, Integer>> sourceContext)
                                    throws Exception {
                                while (running.get()) {
                                    sourceContext.collect(Tuple2.of(random.nextInt(100), 1));
