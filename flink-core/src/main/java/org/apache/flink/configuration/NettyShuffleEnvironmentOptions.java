...
public class NettyShuffleEnvironmentOptions {
    ...
    public static final ConfigOption<Boolean> ADAPTIVE_PARTITIONER_ENABLE =
            key("taskmanager.network.adaptive-partitioner.enabled")
                    ...
                    .defaultValue(false)
                    .withDescription(
                            "Whether to enabled adaptive partitioner feature based on the loading of the downstream task.");
    ...
    public static final ConfigOption<Integer> ADAPTIVE_PARTITIONER_MAX_TRAVERSE_SIZE =
            key("taskmanager.network.adaptive-partitioner.max-traverse-size")
                    ...
                    .defaultValue(10)
                    .withDescription(
                            "How many channels to traverse at most when looking for the idlest channel.");
