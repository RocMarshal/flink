...
public interface WeightLoadable {
    ...
    static <T extends WeightLoadable> List<T> sortByLoadingDescend(@Nonnull Collection<T> weightLoadables) {
        return weightLoadables.stream()
                .sorted((leftLoading, rightLoading) -> rightLoading.getLoading().compareTo(leftLoading.getLoading()))
