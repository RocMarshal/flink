...
final class ResourceRequestPreMappings {
    ...
    // The global variable to keep base mappings result related information, which can assure that
    ...
    // The global variable to keep the remaining available flexible resources besides the
    // baseRequiredResourcePreMappings.
    ...
    private static final class ResourceRequestPreMappingsBuilder {
        ...
        // The global variable to maintain the base mappings result related information, which can
                    ...
                    .forEach(
                            rp ->
                                    Preconditions.checkState(
                                            ...
                                            "The required resource must not be ResourceProfile.ZERO."));
        ...
        private ResourceRequestPreMappings build() {
            ...
            buildUnknownFulfilledMapping();
            return currentPreMappings(isMatchedAll());
        }
        ...
        private void buildUnknownFulfilledMapping() {
        ...
        private ResourceRequestPreMappings currentPreMappings(boolean allMatchable) {
            if (!allMatchable) {
        ...
        private boolean isNotMatchableOverview() {
            return unfulfilledRequired.isEmpty()
                    || availableResources.isEmpty()
                    || isMissingDesiredResourcesOverview();
        }

        private boolean isMatchedAll() {
        ...
        private boolean isMissingDesiredResourcesOverview() {
