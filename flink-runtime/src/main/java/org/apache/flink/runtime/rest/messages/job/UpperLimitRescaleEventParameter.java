 ...
 *
 * @see org.apache.flink.runtime.rest.handler.job.JobRescalesHandler
 */
public class UpperLimitRescaleEventParameter extends MessageQueryParameter<Integer> {

    public static final String KEY = "maxRescaleEvents";

    public UpperLimitRescaleEventParameter() {
