...
public class JobRescalesStatistics implements ResponseBody, Serializable {
    ...
    private final RescalesSummaryDto summary;
    ...
    public JobRescalesStatistics(
            @JsonProperty(FIELD_NAME_SUMMARY) RescalesSummaryDto summary,
    ...
    public static JobRescalesStatistics fromRescalesStatsSnapshot(RescalesStatsSnapshot snapshot) {
        RescalesSummaryDto rescalesSummaryDto =
                RescalesSummaryDto.fromRescalesSummarySnapshot(
    ...
    public static class RescalesSummaryDto implements Serializable {
        ...
        public boolean equals(Object o) {
            ...
            RescalesSummaryDto that = (RescalesSummaryDto) o;
    ...
    public static class RescalesCounts {
        ...
        public static final String FIELD_NAME_IN_PROGRESS_RESCALES = "in_progress_rescales";
        ...
        @JsonProperty(FIELD_NAME_IN_PROGRESS_RESCALES)
        private final long inProgressRescales;
        ...
        public RescalesCounts(
                ...
                @JsonProperty(FIELD_NAME_IN_PROGRESS_RESCALES) long inProgressRescales,
            ...
            this.inProgressRescales = inProgressRescales;
        ...
        public boolean equals(Object o) {
            ...
            return ignoredRescales == that.ignoredRescales
                    && inProgressRescales == that.inProgressRescales
    ...
    public static class LatestRescales implements Serializable {
        ...
        public static LatestRescales fromRescalesStatsSnapshot(RescalesStatsSnapshot snapshot) {
            Rescale completedRescale = snapshot.getLatestRescale(TerminalState.COMPLETED);
            Rescale failedRescale = snapshot.getLatestRescale(TerminalState.FAILED);
            Rescale ignoredRescale = snapshot.getLatestRescale(TerminalState.IGNORED);
