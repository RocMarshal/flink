...
public final class LoadableResourceProfile implements WeightLoadable, Serializable {
    ...
    public boolean isMatching(@Nonnull LoadableResourceProfile requiredLoadableResourceProfile) {
        if (resourceProfile.equals(ResourceProfile.ANY)) {
            return true;
        }
        return resourceProfile.isMatching(requiredLoadableResourceProfile.resourceProfile)
                && Objects.equals(weight, requiredLoadableResourceProfile.weight);
    }
