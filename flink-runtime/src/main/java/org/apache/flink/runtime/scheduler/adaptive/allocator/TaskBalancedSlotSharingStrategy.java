 ...
 * org.apache.flink.runtime.scheduler.adaptive.allocator.SlotSharingStrategy} based on tasks
 * balanced strategy.
 */
public enum TaskBalancedSlotSharingStrategy implements SlotSharingStrategy {
    INSTANCE;
