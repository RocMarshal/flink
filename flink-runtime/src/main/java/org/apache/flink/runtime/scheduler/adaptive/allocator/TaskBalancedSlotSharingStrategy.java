...
/** The implementation of the {@link SlotSharingStrategy} based on tasks balanced strategy. */
enum TaskBalancedSlotSharingStrategy implements SlotSharingStrategy {
    INSTANCE;
