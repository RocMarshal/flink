...
public class StateLocalitySlotAssigner extends SlotAssigner {
    ...
    public StateLocalitySlotAssigner(TaskManagerLoadBalanceMode loadBalanceMode) {
        super(loadBalanceMode, MinimalTaskExecutorSlotsFilter.INSTANCE);
    }
    ...
    public Collection<SlotAssignment> assignSlots(
        ...
        final Map<JobVertexID, Integer> parallelism = vertexParallelism.getParallelismForVertices();
        ...
        return requestSlotMatcher.matchRequestsWithSlots(
                allGroups,
                slotsFilter.filterSlots(freeSlots, allGroups, scores),
    ...
    static class ScoreKey {
        private final String groupId;
        private final AllocationID allocationID;

        ScoreKey(String groupId, AllocationID allocationID) {
            this.groupId = groupId;
            this.allocationID = allocationID;
        }

        ScoreKey(AllocationScore allocationScore) {
            this.groupId = allocationScore.groupId;
            this.allocationID = allocationScore.allocationId;
        }
