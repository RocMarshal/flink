...
/**
 * The policy to define how to construct execution slot sharing groups from the execution vertices
 * of a job with the vertices parallelisms.
 */
public interface SlotSharingPolicy {
    /**
     ...
     */
    List<ExecutionSlotSharingGroup> getExecutionSlotSharingGroups(
