...
public abstract class StreamPartitioner<T>
    ...
    protected final boolean hasNativeAdaptivePartitionerTrait;
    protected final @Nullable Boolean enableAdaptivePartitionTrait;
    protected final @Nullable Integer adaptivePartitionerMaxTraverseSize;
    ...
    public StreamPartitioner(
            boolean hasNativeAdaptivePartitionerTrait,
            @Nullable Boolean enableAdaptivePartitionTrait,
            @Nullable Integer adaptivePartitionerMaxTraverseSize) {
        this.hasNativeAdaptivePartitionerTrait = hasNativeAdaptivePartitionerTrait;
        this.enableAdaptivePartitionTrait = enableAdaptivePartitionTrait;
        this.adaptivePartitionerMaxTraverseSize = adaptivePartitionerMaxTraverseSize;
        if (!hasNativeAdaptivePartitionerTrait && enableAdaptivePartitionTrait != null) {
    ...
    public boolean isEnabledAdaptivePartitionTrait(boolean defaultAdaptivePartitionable) {
        if (!hasNativeAdaptivePartitionerTrait) {
            return false;
        } else {
            // Return the enableAdaptivePartitionTrait if specified manually,
            // defaultAdaptivePartitionable else.
            return Objects.requireNonNullElse(
                    enableAdaptivePartitionTrait, defaultAdaptivePartitionable);
        }
    }

    public int getAdaptivePartitionerMaxTraverseSize(int defaultAdaptivePartitionMaxTraverseSize) {
        if (!hasNativeAdaptivePartitionerTrait) {
            // TODO: throw exception directly.
            return -1;
        } else {
            // Return the adaptivePartitionMaxTraverseSize if specified manually,
            // defaultAdaptivePartitionMaxTraverseSize else.
            return Objects.requireNonNullElse(
                    adaptivePartitionerMaxTraverseSize, defaultAdaptivePartitionMaxTraverseSize);
        }
    }
}
