...
/** Base testing class for the implementations of {@link SlotAssigner}. */
abstract class AbstractSlotAssignerTest {
    ...
    protected SlotAssigner slotAssigner;

    @BeforeEach
    protected void setUp() {
        this.slotAssigner = createSlotAssigner();
    }

    protected abstract SlotAssigner createSlotAssigner();
    ...
    void testAssignSlots() {
        Collection<SlotAssignment> slotAssignments =
                slotAssigner.assignSlots(
                        null, freeSlots, requestedGroups, null, taskExecutorsLoadInformation);
...
/** Test for {@link SlotsBalancedSlotAssigner}. */
class SlotsBalancedSlotAssignerTest extends AbstractSlotAssignerTest {

    @Override
    protected SlotAssigner createSlotAssigner() {
        return new SlotsBalancedSlotAssigner();
    }
...
/** Test for {@link TasksBalancedSlotAssigner}. */
class TasksBalancedSlotAssignerTest extends AbstractSlotAssignerTest {

    @Override
    protected SlotAssigner createSlotAssigner() {
        return new TasksBalancedSlotAssigner();
    }
