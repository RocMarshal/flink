...
class RescaleTest {
    ...
    void testAddSchedulerState() {
        ...
        assertThat(schedulerStateSpan.getStringedException()).isEqualTo(stringedException1);
        assertThat(rescale.getStringedException()).isNull();

        rescale = new Rescale(new RescaleIdInfo(new AbstractID(), 1L));
        rescale.addSchedulerState(new SchedulerStateSpan("", null, null, null, stringedException1));
