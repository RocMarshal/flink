...
import static org.apache.flink.runtime.scheduler.adaptive.allocator.DefaultSlotAssigner.DEPLOYMENT_TARGET;
...
class DefaultSlotAssignerTest {
    ...
    void testAssignSlots() {
        final SlotAssigner slotAssigner = new DefaultSlotAssigner(DEPLOYMENT_TARGET);
