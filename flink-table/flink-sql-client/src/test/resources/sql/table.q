...
[ERROR] Could not execute SQL statement. Reason:
org.apache.flink.table.api.ValidationException: A column named 'amount' already exists in the base table. Metadata columns can only overwrite other metadata columns.
!error
...
alter table t_user add cmp1 as (cost - amount) comment 'c';
[ERROR] Could not execute SQL statement. Reason:
org.apache.flink.table.api.ValidationException: A generated column named 'cmp1' already exists in the base table. You might want to specify EXCLUDING GENERATED or OVERWRITING GENERATED.
!error
...
[ERROR] Could not execute SQL statement. Reason:
org.apache.flink.sql.parser.ddl.columnposition.ReferencedColumnNotFoundException: The column 'non_col' referenced by column 'cmp4' was not found.
!error
...
[ERROR] Could not execute SQL statement. Reason:
org.apache.flink.sql.parser.ddl.columnposition.ReferencedColumnNotFoundException: The column 'non_col' referenced by column 'num3' was not found.
!error
