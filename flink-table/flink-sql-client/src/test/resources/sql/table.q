...
[ERROR] Could not execute SQL statement. Reason:
org.apache.flink.table.api.ValidationException: A column named 'amount' already exists in the base table. Metadata columns can only overwrite other metadata columns when you are using 'create table ... like ...' clause.
!error
